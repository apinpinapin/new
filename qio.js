...
await sleep(30000)
Alwaysaqioo.sendMessage(`6281231948641@s.whatsapp.net`, { text: `BOT VERSION 8 ALFIN FARIDH TAUFIQIY BERHASIL CONNECT️`})
            }
...
Alwaysaqioo.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./indek")(Alwaysaqioo, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
